...
import { PROMPT } from './config/ai-prompt.config';
import { type Account } from './types/account.types';
import { getIndicators } from './services/market-data.service';
import { getOpenPositions } from './services/positions.service';
import { MARKETS } from './config/markets.config';
import { createPosition } from './services/trading.service';
import { cancelAllOrders } from './services/order-management.service';
